...
function calcTax(team, income, years, taxlaw, escrow){
    ...
    if(income.signingBonus != 0){


      var signingBonusFederalTax = (income.signingBonus ) * getFederalTax(team, taxlaw)
      var signingBonusStateTax = (income.signingBonus ) * getStateTax(team, taxlaw)
      var signingBonusIncome = income.signingBonus * getNetIncome(team, taxlaw)
      var signingBonusTax = income.signingBonus * (1- getNetIncome(team, taxlaw))
      console.log("Signing Bonus Income : " + signingBonusIncome)
    } else {
      var signingBonusIncome = 0
      var signingBonusFederalTax = 0
      var signingBonusStateTax = 0
      var signingBonusTax = signingBonusStateTax + signingBonusFederalTax
      console.log("Signing Bonus Income : " + signingBonusIncome)
    }
    ...
    var medicare = income * getMedicareTax(team, taxlaw)
      console.log("Medicare Tax : " + medicare)
    var socialSecurity = 7347
    federalTax = federalTax - socialSecurity
      console.log("Subtract " + socialSecurity + " from Federal Tax : " + federalTax)
    ...
    json.signingBonusIncome = signingBonusIncome
    json.signingBonusTax = signingBonusTax
    json.signingBonusStateTax = signingBonusStateTax
    json.signingBonusFederalTax = signingBonusFederalTax
    json.team = team
    json.income = income
    ...
    json.fica = socialSecurity + medicare
